	...
	<nav class="navbar navbar-inverse">
	  <div class="container-fluid">
	    <div class="navbar-header">
	      <a class="navbar-brand" href="http://localhost/restaurant/ui/admin_home.php">Mr. Chase</a>
	    </div>
	    <ul class="nav navbar-nav">
	      ...
	      <li <?php if($_SESSION['active_adminpage']=="contacts_us"){?> class="active" <?php } ?>  ><a href="http://localhost/restaurant/ui/contacts_us.php">Contact Us</a></li>
	    </ul>
